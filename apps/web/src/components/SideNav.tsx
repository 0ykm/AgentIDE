  ...
  return (
    <nav className="activity-bar">
      <div className="activity-bar-top">
        ...
        <button
          type="button"
          className={`activity-bar-item ${activeView === 'agent' ? 'active' : ''}`}
        ...
        <button
          type="button"
          className={`activity-bar-item ${activeView === 'nodes' ? 'active' : ''}`}
        ...
        >
          <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <circle cx="19" cy="5" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.5"/>
            <circle cx="19" cy="19" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.5"/>
            <path d="M7.5 12h4M16.5 5H14a2 2 0 00-2 2v10a2 2 0 002 2h2.5" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          </svg>
        </button>
      </div>
